...
<head>
	...
	<fmt:message bundle="${loc}" key="local.title.room4" var="title"/>
...
<div class="details">
	<div class="container">
			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="../images/rooms/41.jpg" >
						<div class="carousel-caption">
						</div>
					</div>
					<div class="item">
						<img src="../images/rooms/42.jpg" >
						<div class="carousel-caption">
						</div>
					</div>
				</div>
		...
		<div class="details-top">
			...
			<%--<button type="submit" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" onclick="document.getElementById('primaryButton').click()">123--%>
			<%--</button>--%>
		...
		<div class="booking-form">
			...
			<form action="Controller" method="post">
				...
				<input type="hidden" name="roomID" value="4"><br>
