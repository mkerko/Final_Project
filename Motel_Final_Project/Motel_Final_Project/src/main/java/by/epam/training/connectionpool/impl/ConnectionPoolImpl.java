package by.epam.training.connectionpool.impl;

import by.epam.training.connectionpool.ConnectionPool;
import by.epam.training.connectionpool.ConnectionPoolException;
import by.epam.training.connectionpool.DBResourceManager;
...
public class ConnectionPoolImpl implements ConnectionPool {
	...
	private final String locationOfDriver;
	...
	private void init() throws ConnectionPoolException {
		...
		try {
			...
			throw new RuntimeException("ConnectionPoolImpl ClassNotFound",e);
		} catch (SQLException | InterruptedException e) {
			logger.fatal("ConnectionPoolImpl ClassNotFound",e);
		}
	}
	...
	public Connection takeConnection() throws ConnectionPoolException {
		...
		try {
			...
			logger.fatal("Can not take connection.", e);
		}
		return connection;
	}
	...
	public void returnConnection(Connection connection) throws ConnectionPoolException {
		try {
			...
			logger.fatal("Time is out. Can not put Connection.",e);
		}
