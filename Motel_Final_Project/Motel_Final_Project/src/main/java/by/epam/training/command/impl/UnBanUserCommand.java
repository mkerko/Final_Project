...
import by.epam.training.service.UnBanUserService;
...
import static by.epam.training.command.PagePass.ERROR_MESSAGE;
import static by.epam.training.command.PagePass.TO_USERS;

/**
 * Class {@code UnBanUserCommand} is the class, of the "Command" pattern, that deals with {@code HttpServletResponse}
...
public class UnBanUserCommand implements ICommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        if(status) {
            try {
                UnBanUserService.getInstance().doService(parametersToSend);
