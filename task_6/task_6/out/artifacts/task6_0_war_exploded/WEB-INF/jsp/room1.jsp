...
<!-- details -->
	<div class="details">
		<div class="container">
			...
			<%--</div>--%>
			<form name="1" action="Controller" method="get">
				<input type="hidden" name="action" value="getroominfo"/>
				<input type="hidden" name="roomID" value="1">
				<input class="btn btn-default" id="clickButton" type="submit" value="Show room info">
			</form>

			<span>Description: </span>${room.getDescription()}><br>
